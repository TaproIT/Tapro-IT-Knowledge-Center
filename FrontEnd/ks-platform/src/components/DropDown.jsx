...
function DropDown({dropDownType, options, type, setValue}) {
    ...
    return (
        <div className='relative flex flex-col items-center w-full h-auto rounded'>
            <button
                className={`p-4 py-2 w-full h-12 flex items-center justify-between font-normal 
                ${dropDownType === 'resultList' ? "text-[14px]" : "text-[16px]"} rounded-lg 
                tracking-wider border-[1px] border-drop-down-border focus:border-primary 
